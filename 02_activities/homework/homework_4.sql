...
--Reverse the numbering by ordering the market_date in descending order so that the most recent visit is labeled 1.
SELECT 
    customer_id, 
    market_date,
...
-- Use the above query as a subquery to filter only the customer’s most recent visit.
SELECT 
    customer_id, 
    market_date
FROM 
